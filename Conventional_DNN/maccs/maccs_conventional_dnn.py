...
###create directory
base_path = '/account/tli/CDER/results/check/dnn_maccs/maccs_conventional_dnn'
...
###parameters
col_name2 = 'maccs_conventional_dnn'
...
###load the best_model
best_model = load_model('/account/tli/CDER/results/check/dnn_maccs/maccs_conventional_dnn_1/weights/maccs_conventional_dnn_weights.h5')
