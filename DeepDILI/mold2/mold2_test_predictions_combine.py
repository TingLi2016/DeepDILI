...
knn_base_path = '/account/tli/CDER/results/check/knn/knn_' + var + '/test_class'
lr_base_path = '/account/tli/CDER/results/check/lr/lr_' + var + '/test_class'
svm_base_path = '/account/tli/CDER/results/check/svm/svm_' + var + '/test_class'
rf_base_path = '/account/tli/CDER/results/check/rf/rf_' + var + '/test_class'
xgboost_base_path = '/account/tli/CDER/results/check/xgboost/xgboost_' + var + '/test_class'
