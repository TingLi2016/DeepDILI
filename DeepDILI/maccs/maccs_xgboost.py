...
data = pd.read_csv('/account/tli/CDER/data/fps_extra/dili_1009_maccs.csv',low_memory=False) 
...
###external dataset
#external = pd.read_csv('/account/tli/CDER/data/external_dataset/external_240_maccs.csv')
#cols = data.columns[7:]
...
for col in train_index.columns[9:].values:
    ...
    ###create classifier
    clf = XGBClassifier(learning_rate=0.01, n_estimators=300, max_depth=11, subsample=0.7, scale_pos_weight=0.66)
