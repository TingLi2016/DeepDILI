...
knn_base_path = base_path + '/knn/knn_' + var + '/validation_class'
lr_base_path = base_path +  '/lr/lr_' + var + '/validation_class'
svm_base_path = base_path + '/svm/svm_' + var + '/validation_class'
rf_base_path = base_path + '/rf/rf_' + var + '/validation_class'
xgboost_base_path = base_path + '/xgboost/xgboost_' + var + '/validation_class'

path='/account/tli/CDER/results/check/data/validation'


###get the seed
mcc=pd.read_csv('/account/tli/CDER/data/fps_extra/selected_models/selected_maccs_mcc.csv')
...
tmp = pd.read_csv(join(knn_base_path, 'validation_knn_paras_'+var+'.csv'))
knn = tmp[['id', 'y_true']]
