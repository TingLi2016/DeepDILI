...
base_path = '/account/tli/CDER/results/check/svm/svm_' + var
...
for col in train_index.columns[9:].values:
    ...
    ### define column name 
    col_name = 'svm_'+'seed_'+col+'_paras_'+var
    col_name2 = 'svm_'+'paras_'+var

    ### create and fit model
    clf = SVC(kernel='poly', C=0.1, gamma='scale', probability=True,  class_weight = 'balanced', random_state=1)
