...
for col in train_index.columns[9:].values:
    ...
    ### define column name 
    col_name = 'rf_'+'seed_'+col+'_paras_'+var
    col_name2 = 'rf_'+'_paras_'+var


    ### create and fit model
    clf = RandomForestClassifier(random_state=1, n_estimators=500, max_depth=5,  min_samples_leaf=5, class_weight='balanced', bootstrap = True, max_features='log2')
