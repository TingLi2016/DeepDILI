...
paras = [l for l in itertools.product(kernels, Cs, gammas, years)]
print(len(paras))
para = paras[9]
print(para)
...
base_path = '/account/tli/CDER/results/sequence_feature_selection/svm/svm' + var
...
for i in range(20):
    ...
    for train_index, validation_index in skf.split(X, y):
        ...
        col_name1 = 'svm_'+'seed_'+str(i)+'_paras_'+var+'_kernel_'+para[0]+'_C_'+str(para[1])+'_gamma_'+str(para[2])
        col_name2 = 'svm_'+'paras_'+var

        ### create and fit model
        clf = SVC(kernel=para[0], C=para[1], gamma=para[2], probability=True, random_state=1)#
