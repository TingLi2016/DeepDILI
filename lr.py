...
paras = [l for l in itertools.product(Cs, years)]
print(len(paras))
para = paras[2]
print(para)
...
base_path = '/account/tli/CDER/results/sequence_feature_selection/lr/lr' + var
...
for i in range(20):
    ...
    for train_index, validation_index in skf.split(X, y):
        ...
        ### define column name
        col_name = 'lr_'+'seed_'+str(i)+'_skf_'+str(j)+'_paras_'+var+'_C_'+str(para[0])
        col_name2 = 'lr_'+'paras_'+var
        
        ###create classifier
        clf = LogisticRegression(C=para[0], max_iter=300)
