...
knn_base_path = '/account/tli/CDER/results/sequence_feature_selection/knn/knn' + var + '/test_class'
lr_base_path = '/account/tli/CDER/results/sequence_feature_selection/lr/lr' + var + '/test_class'
svm_base_path = '/account/tli/CDER/results/sequence_feature_selection/svm/svm' + var + '/test_class'
rf_base_path = '/account/tli/CDER/results/sequence_feature_selection/rf/rf' + var + '/test_class'
xgboost_base_path = '/account/tli/CDER/results/sequence_feature_selection/xgboost/xgboost' + var + '/test_class'

path='/account/tli/CDER/results/sequence_feature_selection/data'+'/test'
