...
knn_base_path = '/account/tli/CDER/results/sequence_feature_selection/knn/knn' + var + '/validation_class'
lr_base_path = '/account/tli/CDER/results/sequence_feature_selection/lr/lr' + var + '/validation_class'
svm_base_path = '/account/tli/CDER/results/sequence_feature_selection/svm/svm' + var + '/validation_class'
rf_base_path = '/account/tli/CDER/results/sequence_feature_selection/rf/rf' + var + '/validation_class'
xgboost_base_path = '/account/tli/CDER/results/sequence_feature_selection/xgboost/xgboost' + var + '/validation_class'

path='/account/tli/CDER/results/sequence_feature_selection/data'+'/validation'
